//Complex with copy constructor and with pass by Reference
...
public:
    ...
    Complex Sum(Complex &C){ //call oldC
      Complex Res;
...
int main()
{
     ...
     cout<<"Complex with copy constructor and with pass by Reference"<<endl;
     c3=c1.Sum(c2);
     c3.printComplix();
    return 0;
}
